...
const ProductListComponent = () => {
  ...
  return (
    <div className="h-full px-5 overflow-y-auto">
      <div className="grid grid-cols-10 h-20 items-center text-gray-800 font-semibold text-sm border-b border-gray-200">
        <p className="px-2">Product</p>
        <p className="px-2 col-span-2">Title</p>
        <p className="px-2 col-span-3">Description</p>
