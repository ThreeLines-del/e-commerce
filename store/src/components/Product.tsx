...
const Product: React.FC<ProductProp> = ({ product }) => {
  ...
  return (
    <NavLink to={`/product/${product.id}`}>
      <div className="border border-gray-100 dark:border-gray-600 h-auto flex flex-col gap-5 justify-center items-center pt-7 pb-8 hover:cursor-pointer hover:brightness-95">
